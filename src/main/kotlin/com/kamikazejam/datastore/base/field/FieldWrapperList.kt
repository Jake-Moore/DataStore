...
sealed interface RequiredFieldList<E : Any> : FieldWrapperList<E> {
    companion object {
        @JvmStatic
        fun <E : Any> of(name: String, defaultValue: List<E>? = null): RequiredFieldList<E> =
...
private class RequiredFieldListImpl<E : Any>(
    name: String,
    defaultValue: List<E>?
) : RequiredFieldList<E> {

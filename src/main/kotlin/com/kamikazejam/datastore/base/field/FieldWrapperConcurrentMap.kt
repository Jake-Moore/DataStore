...
sealed interface RequiredFieldConcurrentMap<K : Any, V : Any> : FieldWrapperConcurrentMap<K, V> {
    companion object {
        @JvmStatic
        fun <K : Any, V : Any> of(name: String, defaultValue: ConcurrentMap<K, V>? = null): RequiredFieldConcurrentMap<K, V> =
            RequiredFieldConcurrentMapImpl(name, defaultValue)
    }
}

sealed interface OptionalFieldConcurrentMap<K : Any, V : Any> : FieldWrapperConcurrentMap<K, V> {
    companion object {
        @JvmStatic
        fun <K : Any, V : Any> of(name: String, defaultValue: ConcurrentMap<K, V>? = null): OptionalFieldConcurrentMap<K, V> =
            OptionalFieldConcurrentMapImpl(name, defaultValue)
    }
}

private class RequiredFieldConcurrentMapImpl<K : Any, V : Any>(
    name: String,
    defaultValue: ConcurrentMap<K, V>?
) : RequiredFieldConcurrentMap<K, V> {
...
private class OptionalFieldConcurrentMapImpl<K : Any, V : Any>(
    name: String,
    defaultValue: ConcurrentMap<K, V>?
) : OptionalFieldConcurrentMap<K, V> {
